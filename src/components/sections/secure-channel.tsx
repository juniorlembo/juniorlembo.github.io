...
const channels = [
  {
    title: 'Projets',
    description: 'Explorez mon portfolio de projets de sécurité.',
    link: '#projects',
  ...
  {
    title: 'Articles',
    description: 'Lisez mes dernières analyses et réflexions.',
    link: '#articles',
  ...
  {
    title: 'Compétences',
    description: 'Découvrez mes capacités techniques.',
    link: '#arsenal',
    icon: <Wrench className="w-8 h-8 text-primary" />,
    cta: 'Explorer l\'Arsenal'
  },
  {
    title: 'Contact',
    description: 'Contactez-moi pour des collaborations ou des demandes.',
    link: '#contact',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <p className="font-code text-primary uppercase tracking-widest">Matrice de Navigation</p>
            <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl">
              Sélectionnez un canal sécurisé pour continuer
            </h2>
          </div>
        </div>
