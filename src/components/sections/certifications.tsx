...
const certifications = [
  {
    ...
    description: "Demonstrate expertise in designing distributed systems, and hardening server.",
  ...
  },
  {
    ...
    description: "Applied Cybersecurity to Application, Network, Cloud",
    issuer: "COMPTIA",
    date: "December 2025",
    tags: ["Cloud", "Cybersecurity", "DevOps", "Linux", "Windows"]
  },
  {
    ...
    description: "Validate knowledge of the FortiGate 7",
    issuer: "Fortinet",
    date: "October 2024",
  ...
  },
  {
    ...
    description: "Knowledge of Kubernetes, Cloud Native, and DevOps",
    issuer: "Linux Foundation, CNCF",
    date: "September 2025",
    tags: ["Cloud", "Deployment", "HA", "CI/CD", "DevOps", "Linux"]
  },
  {
    title: "Cyber Threat Management",
    image: ctm,
    link: "https://www.credly.com/badges/7f30415b-37d4-4096-beec-5f1c2808a7bd/public_url",
    description: "How to manage Cyber Threat, setting up SOC",
    issuer: "Coursera",
    date: "March 2025",
    tags: ["Cloud", "Programming", "DevOps", "Linux"]
  },
  {
    title: "Git and GitHub Essentials",
    image: git,
    link: "https://www.credly.com/badges/6a867a37-dfda-4b04-b264-54a1b8a24598/public_url",
    description: "Usage of Git and GitHub for version control and collaboration",
    issuer: "Coursera",
    date: "March 2025",
    tags: ["Cloud", "Programming", "DevOps", "Linux"]
  },
  {
    ...
    description: "Building and Designing Dynamic Website with Reactjs",
    issuer: "Scrimba",
    date: "April 2023",
    tags: ["Cloud", "Programming", "DevOps", "Web Development"]
  },
];
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Showcasing my commitment to continuous learning and expertise in various technical domains.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <div className="flex flex-wrap gap-2">
            ...
            <Badge variant="secondary" className="cursor-pointer">Networking</Badge>
